...
import ear11 from './images/c3.jpg';
import ear12 from './images/c4.jpg';
import ear13 from './images/c5.jpg';
import ear14 from './images/c6.avif';
import ear15 from './images/s4.avif';
import ear16 from './images/c8.jpg';
import './earphones.css';
const Earphones = () => (
  <div>
 <div>
  <div className="earphone1">
    <img src={ear11} alt="Earphone 1" className='eara' />
  ...
  <div className="earphone2">
    <img src={ear12} alt="Earphone 2" className='earb' />
  ...
  <div className="earphone3">
    <img src={ear13} alt="Earphone 3" className='earc' />
  ...
  <div className="earphone4">
    <img src={ear14} alt="Earphone 4" className='eard' />
  ...
  <div className="earphone5">
    <img src={ear15} alt="Earphone 5" className='eare' />
  ...
  <div className="earphone6">
    <img src={ear16} alt="Earphone 6" className='earf' />
